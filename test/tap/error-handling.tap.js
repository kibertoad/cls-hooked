...
test('continuation-local storage glue with a throw in the continuation chain', function (t) {
...
test('synchronous throw attaches the context', function (t) {
  ...
  namespace.run(function () {
    ...
    try {
      ...
      t.equal(namespace.fromException(e)['value'], 'transaction set', 'found the inner value')
    }
